...
test('Should replace [chunkhash] in filename', () => {
  ...
  expect(googleFonts.getFilename('woff2', compiler.createCompilation())).toBe('7c0074b72d0b522f8fdb7c14819a957aba78759f.css')
  expect(googleFonts.getFilename('woff', compiler.createCompilation())).toBe('7c0074b72d0b522f8fdb7c14819a957aba78759f.css')
})
...
test('Should replace [name], [hash] and [chunkhash]', () => {
  ...
  expect(googleFonts.getFilename('woff2', compilation)).toBe('woff2.asdf.ea518415821b9a21f60c0e3731bc1e6c0b7cfabc.css')
  expect(googleFonts.getFilename('woff', compilation)).toBe('woff.asdf.ea518415821b9a21f60c0e3731bc1e6c0b7cfabc.css')
})
